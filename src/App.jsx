  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute bottom-[65px] left-0 z-10 ml-10 pb-14 pl-[calc(1.5rem+25px)] pr-6 md:pb-16 md:pl-[calc(3rem+25px)] md:pr-12 lg:pb-20 lg:pl-[calc(4rem+25px)] lg:pr-16">
